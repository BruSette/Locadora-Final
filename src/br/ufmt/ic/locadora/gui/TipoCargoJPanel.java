...
public class TipoCargoJPanel extends javax.swing.JPanel {
     ...
     */
    public TipoCargoJPanel() {
        tableModel = new TipoCargoTableModel(dao.listar());
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tipocargoJTable = new javax.swing.JTable();

        setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Cargo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 1, 18)))); // NOI18N
        ...
        tipocargoJTable.setModel(tableModel);
        jScrollPane1.setViewportView(tipocargoJTable);
    ...
    private void editarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarjButtonActionPerformed
        ...
        if (tipocargoJTable.getSelectedRowCount() == 1) {
    ...
    private void escluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_escluirjButtonActionPerformed
        // TODO add your handling code here:
        if (tipocargoJTable.getSelectedRowCount() > 0) {
            int confirmacao = JOptionPane.showConfirmDialog(tipocargoJTable, "Confirma a exclusão?");
    ...
    private javax.swing.JTable tipocargoJTable;
