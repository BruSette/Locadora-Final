 ...
 * @author bruno
 */
public class AmbienteDAOImplMysql extends GenericaDAOMysql<Ambiente> implements AmbienteDAO {
  ...
  @Override
    ...
    public Ambiente setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(AmbienteDAOImplMysql.class.getName()).log(Level.SEVERE, null, ex);
        }
        return ambiente;
