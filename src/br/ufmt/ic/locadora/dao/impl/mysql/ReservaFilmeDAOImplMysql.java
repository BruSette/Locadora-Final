 ...
 * @author bruno
 */
public class ReservaFilmeDAOImplMysql extends GenericaDAOPostgres<ReservaFilme> implements ReservaFilmeDAO {
    ...
    public ReservaFilme setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(ReservaFilmeDAOImplMysql.class.getName()).log(Level.SEVERE, null, ex);
        }
        return reserva;
