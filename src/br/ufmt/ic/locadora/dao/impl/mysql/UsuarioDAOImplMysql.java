 ...
 * @author bruno
 */
public class UsuarioDAOImplMysql extends GenericaDAOPostgres<Usuario> implements UsuarioDAO {
    ...
    public Usuario setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(UsuarioDAOImplMysql.class.getName()).log(Level.SEVERE, null, ex);
        }
        return usuario;
