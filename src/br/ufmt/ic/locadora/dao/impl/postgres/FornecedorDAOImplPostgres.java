 ...
 * @author bruno
 */
public class FornecedorDAOImplPostgres extends GenericaDAOPostgres<Fornecedor> implements FornecedorDAO {
...
"rua,cnpj,razao, codigobanco, contanumero, datacadastro) "
    ...
    public Fornecedor setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(FornecedorDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return fornecedor;
    ...
    public PreparedStatement PreparaInserir(PreparedStatement pstm, Fornecedor t) {
        try {
            ...
            System.out.println(t.getDatacadastro());
