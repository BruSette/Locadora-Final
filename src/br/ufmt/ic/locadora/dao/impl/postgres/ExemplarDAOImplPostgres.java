 ...
 * @author bruno
 */
public class ExemplarDAOImplPostgres extends GenericaDAOPostgres<Exemplar> implements ExemplarDAO {
  ...
  @Override
    ...
    public Exemplar setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(ExemplarDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return exemplar;
