 ...
 * @author bruno
 */
public class PontoDAOImplPostgres extends GenericaDAOPostgres<Ponto> implements PontoDAO {
  ...
  @Override
    ...
    public Ponto setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(PontoDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return ponto;
