 ...
 * @author bruno
 */
public class TipoCargoDAOImplPostgres extends GenericaDAOPostgres<TipoCargo> implements TipoCargoDAO {
  ...
  @Override
    ...
    public TipoCargo setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(TipoCargoDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return tipocargo;
