 ...
 * @author bruno
 */
public class BancoDAOImplPostgres extends GenericaDAOPostgres<Banco> implements BancoDAO {
    ...
    public Banco setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(BancoDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return banco;
