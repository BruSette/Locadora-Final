 ...
 * @author bruno
 */
public class DoacaoFilmesDAOImplPostgres extends GenericaDAOPostgres<DoacaoFilmes> implements DoacaoFilmesDAO {
    ...
    public DoacaoFilmes setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(DoacaoFilmesDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return doacao;
