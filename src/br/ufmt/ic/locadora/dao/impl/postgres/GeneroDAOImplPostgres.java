 ...
 * @author bruno
 */
public class GeneroDAOImplPostgres extends GenericaDAOPostgres<Genero> implements GeneroDAO {
  ...
  @Override
    ...
    public Genero setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(GeneroDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return genero;
