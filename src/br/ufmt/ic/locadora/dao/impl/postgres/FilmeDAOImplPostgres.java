 ...
 * @author bruno
 */
public class FilmeDAOImplPostgres extends GenericaDAOPostgres<Filme> implements FilmeDAO {
...
"codigoexemplar=?,codigofornecedor=?,codigofuncionario=?"
    ...
    public Filme setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(FilmeDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return filme;
