 ...
 * @author bruno
 */
public class EntidadeDAOImplPostgres extends GenericaDAOPostgres<Entidade> implements EntidadeDAO {
...
"rua,cnpj,razao, codigobanco, contanumero) "
    ...
    public Entidade setObjeto(ResultSet resultado) {
        ...
        try {
            ...
            Logger.getLogger(EntidadeDAOImplPostgres.class.getName()).log(Level.SEVERE, null, ex);
        }
        return entidade;
